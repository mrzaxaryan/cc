...
public class WindowManager
{
    ...
    public void OpenWindow(string panel)
    {
        ...
        var win = new WindowState
        {
            ...
            X = 100 + offset,
            Y = 80 + offset,
            Width = panel switch { "FileSystem" => 800, "Settings" => 650, "Relay" => 900, "Agents" => 950, "Transfers" => 600, "ExtensionGroups" => 500, "PeParser" => 900, "Base64" => 600, "LnkGenerator" => 750, "PythonLoader" => 650, "PowerShellLoader" => 650, "LoaderSettings" => 600, "RtfGenerator" => 650, "InsecureDeserialization" => 700, _ => 700 },
            Height = 500,
            ZIndex = _topZ
        };
        ClampToViewport(win);
